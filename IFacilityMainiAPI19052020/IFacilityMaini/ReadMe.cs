...
namespace IFacilityMaini
{
    public class ReadMe
    {
        ...
        *   ---for sql server
        *   
        *   vs > Scaffold-DbContext "Server=SRKSDEV007\SQLEXPRESS;Database=i_facility_tsal;user id=sa;password=srks4$;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer  -OutputDir ToolPulse -f
        *   
        *   vs > Scaffold-DbContext "Server=SRKSDEV007\SQLEXPRESS;Database=unitworksccs;user id=sa;password=srks4$;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer -f
        *   
        *   
        *   
